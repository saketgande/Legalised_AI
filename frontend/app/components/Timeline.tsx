...
const ACTION_LABELS: Record<string, string> = {
  ...
  "review.completed": "Redline engine reviewed their paper",
  "change.approved": "Accepted a redline",
  "change.approved_with_edit": "Accepted a redline (edited)",
  "change.rejected": "Rejected a redline",
  "ladder.step.approved": "Approved a step",
  "request.approved": "All changes cleared",
